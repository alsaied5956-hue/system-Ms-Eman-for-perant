...
self.addEventListener("message", (event) => {
  if (event.data?.type === "SKIP_WAITING") {
    ...
    const options = {
      ...
      vibrate: vibrate || getVibrationPattern(type),
...
function displayLoudNotification(title, data) {
  ...
  const options = {
    ...
    vibrate: data.vibrate || getVibrationPattern(data.type), // High-intensity distinct vibration pattern
    silent: false, // Forces device system notification sound to chime at max volume
